...
l_DM_status = feature_matrix_diag[:,0]
l_CHF_status = feature_matrix_diag[:,1]
...
y = np.array(l_DM_status) #vector with classes (HTN control status); cast it as numpy array
#y = np.array(l_status_for_pt_with_htn_meds_recorded_CLINICIAN)
