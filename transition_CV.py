...
#print:
print("CV Results for TRANSITION ~ ALL MEDS")
...
x = feature_matrix_med_counts_OUT_CONTROL_FROM_ALL #set x (feature matrix)
y = np.array(y_OUT_CONTROL_TRANSITION_FROM_ALL) #vector with classes (HTN control status); cast it as numpy array
